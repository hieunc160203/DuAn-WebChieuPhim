		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto mb-2 mb-lg-0">
				<c:choose>
					...
					<c:otherwise>
						<li class="nav-item"><a class="nav-link nav-link-2"
							href="login" id="Login">Login</a></li>
						<li class="nav-item"><a class="nav-link nav-link-3"
...
<div class="tm-hero d-flex justify-content-center align-items-center" id="for-header"
	data-parallax="scroll"
	data-image-src="<c:url value='/templates/user/img/hd11.jpg'/>">
	<form class="d-flex tm-search-form">
		<input class="form-control tm-search-input" type="search"
			placeholder="Search" aria-label="Search">
		<button class="btn btn-outline-success tm-search-btn" type="submit" id="for-seach"> 
