...
<body >
	...
	<div class="container-fluid tm-container-content tm-mt-60">
		<div class="row mb-4">
			<h2 class="col-6 tm-text-primary" id="mau">List Video</h2>
			<div class="col-6 d-flex justify-content-end align-items-center">
				<form action="" class="tm-text-primary" id="mau">
					Page <input type="text" value="1" size="1"
						class="tm-input-paging tm-text-primary" id="mau"> of 200
				</form>
			</div>
		</div>
		...
		<!-- row -->
		<div class="row tm-mb-90" id="mau">
			<div
				class="col-12 d-flex justify-content-between align-items-center tm-paging-col">
				<c:if test='${currentPage == 1 }'>
					<a  id="for-mau" href="javascript:void(0);"
						class="btn btn-primary tm-btn-prev mb-2 disabled" id="mau">Previous</a>
				</c:if>
				<c:if test='${currentPage > 1 }'>
					<a id="for-mau" href="index?page=${currentPage - 1 }"
						class="btn btn-primary tm-btn-prev mb-2" id="mau">Previous</a>
				</c:if>
				<div class="tm-paging d-flex">
					<c:forEach varStatus="i" begin="1" end="${maxPage }">
						<a id="for-mau2" href="index?page=${i.index }"
