...
public class EmailServiceImpl implements EmailService {
	...
	private static final String EMAIL_WELCOME_SUBJECT = "Welcome to PhimCuaTrung";
	private static final String EMAIL_FORGOT_PASSWORD = "PhimCuaTrung - New Password";
